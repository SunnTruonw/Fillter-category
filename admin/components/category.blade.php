            ...
            <div class="d-flex">
                <div class="box-left lb_list_content_recusive ">
                    <div class="d-flex">
                        ...
                        <div class="col-sm-3 pt-2 pb-2 parent text-center wrap-load-hot" data-url="{{ route('admin.categoryproduct.load.hot',['id'=>$value->id]) }}">
                            @include('admin.components.load-change-hot',['data'=>$value,'type'=>'sản phẩm'])
                        </div>
