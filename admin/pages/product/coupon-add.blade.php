        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    @endif
                    <form class="form-horizontal" action="{{route('admin.product.coupon.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div id="tong_quan_{{$langItem['value']}}" class="container tab-pane {{$langItem['value']==$langDefault?'active show':''}} fade">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Tên mã giảm giá</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control 
                                                                    @error('name') is-invalid @enderror" value="{{ old('name') }}" name="name" placeholder="Nhập tên mã giảm giá">
                                                                    @error('name')
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Mã code</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control 
                                                                    @error('code') is-invalid @enderror" id="code" value="{{ old('code') }}" name="code" placeholder="Nhập mã code">
                                                                    @error('code')
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    @error('quantity') is-invalid @enderror" id="quantity" value="{{ old('quantity') }}" name="quantity" placeholder="Nhập số lượng">
                                                                    @error('quantity')
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input type="number" class="form-control 
                                                                    @error('coupon_number') is-invalid @enderror" id="coupon_number" value="{{ old('coupon_number') }}" name="coupon_number" placeholder="Nhập số lượng">
                                                                    @error('coupon_number')
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                </div>
