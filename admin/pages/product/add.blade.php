                                     ...
                                     <div class="card-body table-responsive p-3">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control custom-select select-2-init @error('bo_suu_tap')
                                                ...
                                                @if (old('bo_suu_tap'))
                                                    {!! \App\Models\CategoryProduct::getHtmlOptionAddWithParent(old('bo_suu_tap')) !!}
                                                @else
                                                {!!$optionBTS!!}
                                                @endif
                                            </select>
                                    ...
                                    <div class="card-body table-responsive p-3">
                                        <div class="item-price-default">
                                            ...
                                            {{-- <div class="form-group">
                                                ...
                                                <input type="text" min="0" class="form-control  @error('size') is-invalid  @enderror"  value="{{ old('size') }}" name="size" placeholder="Nhập kg">
                                                @error('size')
                                                <div class="invalid-feedback d-block">{{ $message }}</div>
                                                @enderror
                                            </div> --}}
