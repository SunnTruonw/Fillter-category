...
<div class="content-wrapper lb_template_product_edit">
    @include('admin.partials.content-header',['name'=>"Màu","key"=>"Sửa Màu"])
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box-link">
                        ...
                        <a href="{{ route('admin.product.size',['product_id'=>$data->product_id,'option_id'=>$data->id]) }}" class="btn btn-sm btn-success">Danh sách Khung</a>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    ...
                                                                    @error('size') is-invalid @enderror" id="size" value="{{ old('size')??$data->size }}" name="size" placeholder="Nhập tên">
                                                                    @error('size')
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <select class="form-control"  name="attribute" >
                                                                        ...
                                                                        @foreach ($attributes->childs()->orderby('order')->get() as $attr)
                                                                            <option value="{{ $attr->id }}" @if ($attr->id == $data->color_id) selected @endif>{{ $attr->name }}</option>
                                                                        @endforeach
                                                                    </select>
                                                                    @error('attribute')
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                            ...
                                            <div id="hinh_anh" class="container tab-pane fade"><br>
                                                ...
                                                <div class="wrap-load-image mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control-file img-load-input border" id="" name="hover_path">
                                                    </div>
                                                    @error('hover_path')
                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                    @enderror
                                                    @if ($data->hover_path)
                                                    <img class="img-load border p-1 w-100" src="{{$data->hover_path}}" alt="{{$data->size}}" style="height: 200px;object-fit:cover; max-width: 260px;">
                                                    @endif
                                                </div>
