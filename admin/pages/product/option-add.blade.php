...
<div class="content-wrapper">
    @include('admin.partials.content-header',['name'=>"Màu","key"=>"Thêm Màu"])
    <!-- Main content -->
    <div class="content">
                                                ...
                                                <div class="tab-content">
                                                    ...
                                                    <div id="tong_quan_{{$langItem['value']}}" class="container tab-pane {{$langItem['value']==$langDefault?'active show':''}} fade">
                                                        <div class="form-group">
                                                            <div class="row">
                                                                <label class="col-sm-2 control-label" for="">Tên màu</label>
                                                                <div class="col-sm-10">
                                                                    <input type="text" class="form-control 
                                                                    @error('size') is-invalid @enderror" value="{{ old('size') }}" name="size" placeholder="Nhập tên màu">
                                                                    @error('size')
                                                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                                                    @enderror
                                            ...
                                            <div id="hinh_anh" class="container tab-pane fade"><br>
                                                ...
                                                <div class="wrap-load-image mb-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="file" class="form-control-file img-load-input border @error('hover_path')
                                                        is-invalid
                                                        @enderror" id="" name="hover_path">
                                                        @error('hover_path')
                                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                                        @enderror
                                                    </div>
