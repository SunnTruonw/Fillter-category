                           ...
                           <div class="card-body table-responsive p-0">
                              <table class="table table-head-fixed">
                                 <thead>
                                    <tr>
                                        <th style="display: flex;
                                            ...
                                            <div>
                                                <button type="button" class="btn btn-danger btn-xs delete-all"><i class="far fa-trash-alt"></i></button>
                                            </div>
                                        </th>
                                       <th>ID</th>
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                        <td><input type="checkbox" class="checkbox" data-id="{{$transaction->id}}"></td>
        ...
        if(idsArr.length <=0)  {  
            alert("Vui lòng chọn ít nhất một bản ghi để xóa.");  
                ...
                if(confirm("Bạn có chắc chắn không, bạn muốn xóa các bản ghi đã chọn ?")){  
                    ...
                    $.ajax({
                    url: "{{ route('admin.transaction.multiple_transaction_delete') }}",
                    type: 'POST',
