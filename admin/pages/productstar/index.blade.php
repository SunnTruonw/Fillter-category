                        ...
                        <div class="card card-outline card-primary">
                           <div class="card-header">
                              ...
                              <div class="card-tools w-60">
                                  <form action="{{ route('admin.productstar.index') }}" method="GET">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 text-right">
                                            ...
                                            <a href="{{ route('admin.productstar.index') }}" class="btn btn-danger">Làm lại</a>
                                        </div>
                              ...
                              <table class="table table-head-fixed">
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                         ...
                                         <td>{{ $productstar->phone }}</td>
                                         <td>{{ $productstar->content }}</td>
                                         <td class="wrap-load-hot" data-url="{{ route('admin.productstar.load.hot',['id'=>$productstar->id]) }}">
                                            @include('admin.components.load-change-hot1',['data'=>$productstar,'type'=>'đánh giá'])
                                         </td>
                                         <td class="text-nowrap">{{ $productstar->created_at }}</td>
                                         <td>
                                            <a href="" data-url="{{route('admin.productstar.destroy',['id'=>$productstar->id])}}"  class="btn btn-sm btn-info btn-danger lb_delete"><i class="far fa-trash-alt"></i></a>
                                        </td>
                                      </tr>
                                     @endforeach
